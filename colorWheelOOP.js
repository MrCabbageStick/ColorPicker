class SliderObject{
     ...
     */
    constructor(elem, onPress = null, onRelease = null, onSlide = null){
        this.elem = elem;
...
class ColorPicker{
     ...
     * @param {bool} updateOnCreate
     * @param {(color: {hue: number, saturation: number, lightness: number}) => any} onColorChange
     */
    constructor(hueSliderElem, saturationSliderElem, lightnessSliderElem, onColorChange = null, updateOnCreate = true){
        ...
        if(updateOnCreate) this._onColorChange();
